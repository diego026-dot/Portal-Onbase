						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Pedimentos</li>
								</ol>
							</nav>
						</div>
...
<table class="container-fluid">
	<tr style="border:hidden">
			<td align="center" width="33%" height="250px" style="background-color: white; border:hidden;">
				<button type="button" class="btn btn-light" style="margin:10px" onClick="consultaPedimentos()" title="Consulta pedimentos">
			<img class="borderedondo" src=<?php echo constant('URL') . 'public/img/menu_ccd/ccd.png'?>
			title="Consulta reclamos" onClick="consultaPedimentos()" width="140px"/>
			    </button>
			       <div style="color:#293080; font-weight:bold; font-size:18px;">CONSULTA PEDIMENTOS</div>
			</td>
	</tr>
...
<script>
function consultaPedimentos(){
	window.location='<?php echo constant('URL')?>onbase/pedimentosTiempos/';
      }
