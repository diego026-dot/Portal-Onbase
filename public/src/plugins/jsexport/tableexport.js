        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function checkCaption(exportButton) {
                    ...
                    $caption.length ? $caption.append(exportButton) : $el.prepend('<caption id="excel" class="' + bootstrapSpacing + self.settings.position + '" >' + exportButton + '</caption>');
                }
                ...
                function createObjButton(dataObject, myContent, myClass) {
                    var exportButton = "<button class='btn btn-dark btn-sm' id='boton_excel' data-fileblob='" + dataObject + "' class='" + bootstrapClass + bootstrapTheme + myClass + "'>" + myContent + "</button>";
