					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">ECRS</a></li>
...
<?php foreach($this->consulta_opcionesING as $row){ //INICIO DEL FOR ?>	
	<?php if($row->IdOpcion ==22){ ?>	
	   <div class="col-sm-3">	
       <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
       <div class="card-body">
       <button type="button" class="btn btn-light" style="margin:10px" onClick="ccd_cambiosING()" title="Cambios de ing">
			<img class="borderedondo" src=<?php echo constant('URL') . 'public/img/menu_ccd/nuevodoc.png'?>
			title="Dashboard" width="140px"/>
			    </button> 
		<div style="color:#293080; font-weight:bold; font-size:18px;">SOLICITUD CAMBIOS DE ING</div>
        </div>
        </div> 
	    </div>
        <?php } ?> <!-- fin del if -->
