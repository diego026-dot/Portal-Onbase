...
<div class="container-fluid" style="margin-top: 0; padding-top: 0;">
    ...
    <div class="row mt-5 justify-content-center align-items-center mb-3">
        <div class="col-lg-2 col-md-12 mr-4 mb-3">
        ...
        <div class="col-md-2 mt-1">
            ...
            <button type="button" onclick="enviaDatos();" class="btn btn-success" id="botonExcel"> Descarga Excel</button>
        ...
        function enviaDatos() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // XLSX.utils.book_append_sheet(wb, ws, `${fechaI}-${fechaF}`);

                    // // 3. Descargar el archivo
                    // XLSX.writeFile(wb, `${cliente}-${fechaI}-${fechaF}.xlsx`);
