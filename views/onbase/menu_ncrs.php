						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">NCRs</li>
								</ol>
							</nav>
						</div>
...
<table class="container-fluid">
	<tr style="border:hidden">
			...
			title="Metas Corporativas" onClick="nueva_ncr()" width="140px"/>
			       ...
			       <div style="color:#293080; font-weight:bold; font-size:18px;">NUEVA NCR</div>
			</td>
			...
			<td align="center" width="33%" height="250px" style="background-color: white; border:hidden;">
				<button type="button" class="btn btn-light" style="margin:10px" onClick="accionesCorrectivas()" title="Consulta">
			<img class="borderedondo" src=<?php echo constant('URL') . 'public/img/menu_ccd/ccd.png'?>
			title="Metas Corporativas" onClick="accionesCorrectivas()" width="140px"/>
			    </button>
			       <div style="color:#293080; font-weight:bold; font-size:18px;">ACCIONES CORRECTIVAS</div>
			</td>
	</tr>
